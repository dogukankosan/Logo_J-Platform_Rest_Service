...
[![License](https://img.shields.io/github/license/dogukankosan/Logo_J-Platform_Rest_Service)](LICENSE) [![Stars](https://img.shields.io/github/stars/dogukankosan/Logo_J-Platform_Rest_Service)](https://github.com/dogukankosan/Logo_J-Platform_Rest_Service/stargazers) [![Issues](https://img.shields.io/github/issues/dogukankosan/Logo_J-Platform_Rest_Service)](https://github.com/dogukankosan/Logo_J-Platform_Rest_Service/issues) [![Last Commit](https://img.shields.io/github/last-commit/dogukankosan/Logo_J-Platform_Rest_Service)](https://github.com/dogukankosan/Logo_J-Platform_Rest_Service/commits/main) [![.NET Framework](https://img.shields.io/badge/.NET-Framework_4.8-blue?logo=dotnet)](https://learn.microsoft.com/dotnet/) [![Windows Forms](https://img.shields.io/badge/Windows%20Forms-UI-lightgrey)](https://learn.microsoft.com/dotnet/desktop/winforms/) [![DevExpress](https://img.shields.io/badge/DevExpress-WinForms-orange)](https://www.devexpress.com/) [![SQLite](https://img.shields.io/badge/SQLite-Database-lightgrey?logo=sqlite)](https://www.sqlite.org/)

> **Logo J-Platform REST Service**, Logo J-Platform REST API ile tam entegre çalışan, **muhasebe fişi (GL Slip)**, **Excel tabanlı toplu aktarım**, **malzeme yönetimi**, **AI ile görsel üretim** ve **lisanslama** özelliklerini tek çatı altında sunan bir C#/.NET WinForms uygulamasıdır.  
> ✅ Token tabanlı güvenlik ✅ Excel validasyon ✅ AI entegrasyonu ✅ Dinamik loglama ✅ Çoklu veritabanı desteği  

---

## 🚀 Özellikler
- 🔐 **Oturum Yönetimi & Lisanslama**  
  - Token tabanlı login/logout  
  - Otomatik token yenileme  
  - Lisans anahtarı doğrulama ve giriş ekranı  

- 📊 **Genel Muhasebe (GL Slip)**  
  - Fiş oluşturma, gün bazlı fiş (GLSlipDay)  
  - Excel’den fiş import etme  
  - Borç / Alacak toplam kontrolü  
  - Grup / Grup Çöz işlemleri  

- 🖼 **AI & Görsel Yönetimi**  
  - Stability AI ile malzeme görseli üretme  
  - Dosyadan toplu resim atama  
  - AI + Dosya hibrit atama  
  - Google Gemini API ile açıklama çeviri  
  - Renkli durum bildirimleri (🟢 Başarılı / 🟡 Uyarı / 🔴 Hata)  

- 🗂 **Malzeme Yönetimi**  
  - Malzeme kartlarını listeleme  
  - Toplu görsel güncelleme  
  - ERP / J-Platform’a tek tıkla aktarım  

- ⚙️ **Sistem Ayarları**  
  - REST bağlantı ayarları  
  - SQL bağlantı ayarları  
  - Modül ayar ekranları  

- 📝 **Log & İzleme**  
  - İşlem bazlı log ekranı  
  - SQLite ile hata/günlük kaydı  
  - Kullanıcı hata kayıtları raporu  

- 🎨 **Kullanıcı Deneyimi**  
  - DevExpress grid + modern UI  
  - Tema desteği (Karanlık / Açık)  
  - Çoklu dil (TR/EN)  
